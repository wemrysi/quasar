...
trait DefaultOrderings {
  ...
  def Tuple4Ordering[T1, T2, T3, T4](implicit o1: Ordering[T1], o2: Ordering[T2], o3: Ordering[T3], o4: Ordering[T4]): Ordering[(T1, T2, T3, T4)] =
    new Ordering[(T1, T2, T3, T4)] {
      def compare(v1: (T1, T2, T3, T4), v2: (T1, T2, T3, T4)): Int =
        o1.compare(v1._1, v2._1) |- o2.compare(v1._2, v2._2) |- o3.compare(v1._3, v2._3) |- o4.compare(v1._4, v2._4)
    }

  def Tuple5Ordering[T1, T2, T3, T4, T5](implicit o1: Ordering[T1],
                                         o2: Ordering[T2],
                                         o3: Ordering[T3],
                                         o4: Ordering[T4],
                                         o5: Ordering[T5]): Ordering[(T1, T2, T3, T4, T5)] = new Ordering[(T1, T2, T3, T4, T5)] {
    def compare(v1: (T1, T2, T3, T4, T5), v2: (T1, T2, T3, T4, T5)): Int =
      o1.compare(v1._1, v2._1) |- o2.compare(v1._2, v2._2) |- o3.compare(v1._3, v2._3) |- o4.compare(v1._4, v2._4) |- o5.compare(v1._5, v2._5)
  }
  ...
  def SetOrdering[T](ordering: Ordering[T]): Ordering[Set[T]] = new Ordering[Set[T]] {
    def compare(v1: Set[T], v2: Set[T]): Int =
      ListOrdering(ordering).compare(v1.toList.sortWith(ordering.compare(_, _) < 0), v2.toList.sortWith(ordering.compare(_, _) < 0))
  }
