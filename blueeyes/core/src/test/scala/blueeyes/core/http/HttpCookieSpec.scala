...
class HttpCookieSpec extends Specification {
  ...
  "HttpCookies: Should parse cookies with expires date" in {
    check(
      "Cat=Mittens; expires=Mon, 01-Jan-2001 00:00:00 UTC",
      CookieData("Cat", "Mittens", HttpDateTimes.parseHttpDateTimes("Mon, 01-Jan-2001 00:00:00 UTC")))
  }
  ...
  "HttpCookies: Should parse cookies with  all information" in {
    check(
      "Cat=Mittens; expires=Mon, 01-Jan-2001 00:00:00 UTC; path=/foo; domain=google.com",
      CookieData("Cat", "Mittens", HttpDateTimes.parseHttpDateTimes("Mon, 01-Jan-2001 00:00:00 UTC"), Some("/foo"), Some("google.com")))
  }
