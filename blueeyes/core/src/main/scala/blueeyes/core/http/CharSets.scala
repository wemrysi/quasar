...
object CharSets extends RegexParsers {
  ...
  private def elementParser: Parser[CharSet] = regex("""([a-zA-Z\-_\d])+""".r) ^^ {
    case str =>
  ...
  case object `US-ASCII`
      extends StandardCharSet(
        "iso-ir-6" :: "ANSI_X3.4-1986" :: "ISO_646.irv:1991" :: "ASCII" :: "ISO646-US" :: "US-ASCII" :: "us" :: "IBM367" :: "cp367" :: "csASCII" :: Nil)

  case object `ISO-8859-1`
      extends StandardCharSet("iso-ir-100" :: "ISO_8859-1" :: "ISO-8859-1" :: "latin1" :: "l1" :: "IBM819" :: "CP819" :: "csISOLatin1" :: Nil)
  ...
  case object `ISO-8859-6`
      extends StandardCharSet("iso-ir-127" :: "ISO_8859-6" :: "ISO-8859-6" :: "ECMA-114" :: "ASMO-708" :: "arabic" :: "csISOLatinArabic" :: Nil)

  case object `ISO-8859-7`
      extends StandardCharSet("iso-ir-126" :: "ISO_8859-7" :: "ISO-8859-7" :: "ELOT_928" :: "ECMA-118" :: "greek" :: "greek8" :: "csISOLatinGreek" :: Nil)
