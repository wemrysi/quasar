...
trait PartialFunctionCombinators {
  ...
  implicit def orPartialFunctionCombinatorSugarExtractor1[T, S, U1](r1: (U1 => PartialFunction[T, S]) => PartialFunction[T, S]) =
    new OrPartialFunctionCombinatorSugarExtractor1(r1)
  ...
  implicit def andPartialFunctionCombinatorSugarExtractor1[T, S, U1, V1](r1: (U1 => PartialFunction[T, S]) => PartialFunction[T, S]) =
    new AndPartialFunctionCombinatorSugarExtractor1(r1)
  ...
  implicit def andPartialFunctionCombinatorSugarExtractor2[T, S, U1, U2](r1: ((U1, U2) => PartialFunction[T, S]) => PartialFunction[T, S]) =
    new AndPartialFunctionCombinatorSugarExtractor2(r1)
  ...
  implicit def andPartialFunctionCombinatorSugarExtractor3[T, S, U1, U2, U3](r1: ((U1, U2, U3) => PartialFunction[T, S]) => PartialFunction[T, S]) =
    new AndPartialFunctionCombinatorSugarExtractor3(r1)
  ...
  implicit def andPartialFunctionCombinatorSugarExtractor4[T, S, U1, U2, U3, U4](r1: ((U1, U2, U3, U4) => PartialFunction[T, S]) => PartialFunction[T, S]) =
    new AndPartialFunctionCombinatorSugarExtractor4(r1)
  ...
  implicit def andPartialFunctionCombinatorSugarExtractor5[T, S, U1, U2, U3, U4, U5](
      r1: ((U1, U2, U3, U4, U5) => PartialFunction[T, S]) => PartialFunction[T, S]) = new AndPartialFunctionCombinatorSugarExtractor5(r1)
