...
//   */
// private[cache] class ExpirableMap[K, V](delegate: JConcurrentMap[K, Expirable[K, V]],
...
//     else if (hasExpired(expirable)) { handleExpiration(expirable); None } else {
...
//     if (old == null) None
//     else if (hasExpired(old)) { handleExpirationAfterRemoval(old); None } else Some(old.value)
//   }
...
//     if (old == null) false
//     else if (hasExpired(old)) { handleExpiration(old); false } else if (old.value == value) delegate.remove(key, old)
//     else false
//   }
...
//     if (old == null) None
//     else if (hasExpired(old)) { handleExpiration(old); None } else {
//       val expirable = Expirable[K, V](key, value, policy)
...
//     if (old == null) false
//     else if (hasExpired(old)) { handleExpiration(old); false } else if (!oldValue.equals(old._value)) false
//     else {
