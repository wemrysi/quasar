...
//     var evicted = false
//     val map = Cache.concurrent(CacheSettings[String, String](ExpirationPolicy(None, None, MILLISECONDS), 1, { (key: String, value: String) =>
...
//     var expired = false
//     val map = Cache.concurrent(settings(None, Some(200), { (key: String, value: String) =>
...
//   private def settings(timeToIdle: Option[Long] = None, timeToLive: Option[Long] = None, evict: (String, String) => Unit = { (key: String, value: String) =>
//     }) = CacheSettings[String, String](ExpirationPolicy(timeToIdle, timeToLive, MILLISECONDS), 100, evict)
// }
