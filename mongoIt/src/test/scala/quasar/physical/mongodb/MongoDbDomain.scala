...
trait MongoDbDomain {
  ...
  val timeDomain: Gen[LocalTime] = TimeGenerators.genLocalTime
  val intervalDomain: Gen[DateTimeInterval] = TimeGenerators.genDateTimeInterval
  val timezoneDomain: Gen[ZoneOffset] = TimeGenerators.genZoneOffset
}
