...
lazy val niflheim = project.assemblyProject.usesCommon dependsOn util deps (
  "org.objectweb.howl" % "howl" % "1.0.1-1"
)
lazy val yggdrasil = project.assemblyProject.usesCommon dependsOn (util, bytecode, niflheim) deps (
