...
final class Compiler[M[_], T: Equal]
  ...
  private def compile0
    ...
    val functionMapping = Map[CIName, GenericFunc[_]](
      ...
      CIName("as_number")               -> structural.AsNumber,
      CIName("as_string")               -> structural.AsString,
      CIName("as_boolean")              -> structural.AsBoolean,
      CIName("as_date")                 -> structural.AsDate,
      CIName("as_null")                 -> structural.AsNull,
