...
final class MapFuncPlanner[T[_[_]]: RecursiveT, M[_], F[_]: Applicative] {
  def plan(cake: Precog): AlgebraM[F, MapFuncCore[T, ?], cake.trans.TransSpec1] = {
    case MapFuncsCore.Undefined() =>
      (cake.trans.Map1[cake.trans.Source1](cake.trans.TransSpec1.Id, Undefined): cake.trans.TransSpec1).point[F]
    ...
    case MapFuncsCore.Constant(ejson) =>
      ...
      cake.trans.transRValue(rvalue, cake.trans.TransSpec1.Id).point[F]
    ...
    case MapFuncsCore.Negate(a1) =>
      (cake.trans.Map1[cake.trans.Source1](a1, math.Negate): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Add(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Add.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Multiply(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Mul.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Subtract(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Sub.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Divide(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Div.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Modulo(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Mod.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Power(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Pow.f2): cake.trans.TransSpec1).point[F]

    case MapFuncsCore.Not(a1) => ???
    case MapFuncsCore.Eq(a1, a2) =>
      (cake.trans.Equal[cake.trans.Source1](a1, a2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Neq(a1, a2) => ???
    case MapFuncsCore.Lt(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Lt.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Lte(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.LtEq.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Gt(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Gt.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Gte(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.GtEq.f2): cake.trans.TransSpec1).point[F]

    case MapFuncsCore.IfUndefined(a1, a2) => ???
    case MapFuncsCore.And(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.And.f2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.Or(a1, a2) =>
      (cake.trans.Map2[cake.trans.Source1](a1, a2, cake.Library.Infix.Or.f2): cake.trans.TransSpec1).point[F]
    ...
    case MapFuncsCore.MakeArray(a1) =>
      (cake.trans.WrapArray[cake.trans.Source1](a1): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.MakeMap(key, value) =>
      (cake.trans.WrapObjectDynamic[cake.trans.Source1](key, value): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.ConcatArrays(a1, a2) =>
      (cake.trans.OuterArrayConcat[cake.trans.Source1](a1, a2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.ConcatMaps(a1, a2) =>
      (cake.trans.OuterObjectConcat[cake.trans.Source1](a1, a2): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.ProjectIndex(src, index) =>
      (cake.trans.DerefArrayDynamic[cake.trans.Source1](src, index): cake.trans.TransSpec1).point[F]
    case MapFuncsCore.ProjectField(src, field) =>
      (cake.trans.DerefObjectDynamic[cake.trans.Source1](src, field): cake.trans.TransSpec1).point[F]
