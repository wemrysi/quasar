...
trait TransformSpec extends TableQspec {
  ...
  def testDeepMap1CoerceToDouble = {
    ...
    checkTransform(
      SampleData(data.toStream),
      DeepMap1(DerefObjectStatic(Leaf(Source), CPathField("value")), lookupF1(Nil, "coerceToDouble")),
      _ => expected.toStream
    )
  }
  ...
  def testMap1CoerceToDouble = {
    ...
    checkTransform(
      SampleData(data.toStream),
      Map1(DerefObjectStatic(Leaf(Source), CPathField("value")), lookupF1(Nil, "coerceToDouble")),
      _ => expected.toStream
    )
  }
