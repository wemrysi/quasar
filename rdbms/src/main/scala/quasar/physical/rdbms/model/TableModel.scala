...
object TableModel {
  ...
  def simpleColumnType(data: Type): ColumnType = {
    ...
    data match {
      ...
      case t.Bool    => BoolCol
      case t.Dec     => DecCol
      case t.OffsetDateTime => JsonCol
      case t.OffsetDate => JsonCol
      case t.OffsetTime => JsonCol
      case t.LocalDateTime => JsonCol
      case t.LocalDate => JsonCol
      case t.LocalTime => JsonCol
      case t.Id      => JsonCol
